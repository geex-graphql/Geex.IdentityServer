...
using UserClaim = Geex.IdentityServer.Identity.UserClaim;

namespace Geex.IdentityServer
{
    public class IdentityServerDbContext: IdentityDbContext<User, Role, int, Identity.UserClaim, UserRole, UserLogin, RoleClaim, UserToken>,
        IConfigurationDbContext, IPersistedGrantDbContext
    {
        ...
        private void ConfigureIdentityContext(ModelBuilder builder)
        {
            ...
            builder.Entity<Identity.UserClaim>().ToTable("UserClaims");
